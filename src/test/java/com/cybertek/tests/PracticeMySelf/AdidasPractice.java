...
public class AdidasPractice {
    ...
    public void adidasTest(){
        ...
        expectedOrderAmmount+= OfficeHoursUtils1.productAdder(driver,"Laptops","Sony vaio i5");
        // Navigate to "Phones" → "Samsung galaxy s6" and click on "Add to cart" and adding the price to order amount
        expectedOrderAmmount+=OfficeHoursUtils1.productAdder(driver,"Phones","Samsung galaxy s6");
        // Navigate to "Monitors" → "Apple monitor 24" and click on "Add to cart" and adding the price to order amount
        expectedOrderAmmount+=OfficeHoursUtils1.productAdder(driver,"Monitors","Apple monitor 24");

        // Remove  Apple monitor 24
        expectedOrderAmmount-= OfficeHoursUtils1.productRemover(driver,"Apple monitor 24");
